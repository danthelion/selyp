...
enum {
    LVAL_ERR, LVAL_NUM, LVAL_SYM, LVAL_FUN, LVAL_SEXPR, LVAL_QEXPR, LVAL_STR
};
...
lval *builtin_load(lenv *e, lval *a) {
    ...
    mpc_result_t r;
    if (mpc_parse_contents(a->cell[0]->str, Selyp, &r)) {
...
int main(int argc, char **argv) {
    ...
    mpca_lang(MPCA_LANG_DEFAULT,
      ...
      selyp   : /^/ <expr>* /$/ ;                            \
    ",
              Number, Symbol, String, Comment, Sexpr, Qexpr, Expr, Selyp);
    ...
    lenv_del(e);
    mpc_cleanup(8, Number, Symbol, String, Comment, Sexpr, Qexpr, Expr, Selyp);
    return 0;
}
